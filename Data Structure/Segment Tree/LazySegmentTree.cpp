class SegmentTree {
  ...
  public:
    SegmentTree(int sz) : n(sz), st(4 * n), lazy(4 * n, -1) {} // Constructor de st sin valores

    SegmentTree(const vi &initialA) : SegmentTree((int)initialA.size()) { // Constructor de st con arreglo inicial
        A = initialA;
        build(1, 0, n - 1);
    }
